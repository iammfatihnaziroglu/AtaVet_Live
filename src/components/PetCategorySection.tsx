      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-4 md:gap-6 mb-12 md:mb-16 max-w-4xl mx-auto">
          <Link href="/hayvanlar/kediler" className="group flex flex-col items-center">
            <div className="w-16 h-16 sm:w-20 sm:h-20 md:w-22 md:h-22 flex items-center justify-center rounded-full bg-background shadow-md border border-light-gray p-3 mb-2 transition-all duration-300 group-hover:bg-primary/10 group-hover:scale-110">
            ...
            <span className="font-medium text-sm md:text-base text-foreground group-hover:text-primary transition-colors text-center">Kediler</span>
          </Link>
          ...
          <Link href="/hayvanlar/kopekler" className="group flex flex-col items-center">
            ...
            <span className="font-medium text-sm md:text-base text-foreground group-hover:text-primary transition-colors text-center">Köpekler</span>
          </Link>
          ...
          <Link href="/hayvanlar/kuslar" className="group flex flex-col items-center">
            ...
            <span className="font-medium text-sm md:text-base text-foreground group-hover:text-primary transition-colors text-center">Kuşlar</span>
          </Link>
          ...
          <Link href="/hayvanlar/tavsan" className="group flex flex-col items-center">
            ...
            <span className="font-medium text-sm md:text-base text-foreground group-hover:text-primary transition-colors text-center">Tavşan</span>
          </Link>
          ...
          <Link href="/hayvanlar/diger" className="group flex flex-col items-center">
            ...
            <span className="font-medium text-sm md:text-base text-foreground group-hover:text-primary transition-colors text-center">Diğer Türler</span>
          </Link>
        </div>
