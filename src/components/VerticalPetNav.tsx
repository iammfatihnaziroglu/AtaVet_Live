      ...
      <div className="bg-white/80 dark:bg-foreground/10 backdrop-blur-md rounded-full py-4 px-3 shadow-lg border border-light-gray/50 dark:border-light-gray/20 flex flex-col items-center gap-3 relative overflow-visible hover:shadow-xl transition-all duration-300">
        ...
        <div className="relative z-10 group">
          <Link 
            ...
            className={`flex items-center justify-center w-12 h-12 ${activeCategory === 'kuslar' ? 'bg-primary text-white' : 'bg-white'} rounded-full shadow-md border border-light-gray p-2.5 transition-all duration-300 hover:scale-110`}
            title="Kuş Öyküleri"
          >
            <svg width="32" height="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-7 h-7">
          ...
          <div className="absolute right-14 top-1/2 -translate-y-1/2 bg-white backdrop-blur-sm px-3 py-2 rounded-lg shadow-lg text-sm whitespace-nowrap border border-primary opacity-0 group-hover:opacity-100 transition-all duration-300 pointer-events-none flex items-center gap-2 z-[100]">
            <span className="text-[#E31E24] font-medium">Kuş Öyküleri</span>
            <div className="absolute top-1/2 -translate-y-1/2 right-[-6px] w-3 h-3 bg-white backdrop-blur-sm rotate-45 border-r border-t border-primary"></div>
          </div>
        ...
        <div className="relative z-10 group">
          <Link 
            ...
            className={`flex items-center justify-center w-12 h-12 ${activeCategory === 'tavsan' ? 'bg-primary text-white' : 'bg-white'} rounded-full shadow-md border border-light-gray p-2.5 transition-all duration-300 hover:scale-110`}
          ...
          <div className="absolute right-14 top-1/2 -translate-y-1/2 bg-white backdrop-blur-sm px-3 py-2 rounded-lg shadow-lg text-sm whitespace-nowrap border border-primary opacity-0 group-hover:opacity-100 transition-all duration-300 pointer-events-none flex items-center gap-2 z-[100]">
            <span className="text-[#E31E24] font-medium">Tavşan Öyküleri</span>
            <div className="absolute top-1/2 -translate-y-1/2 right-[-6px] w-3 h-3 bg-white backdrop-blur-sm rotate-45 border-r border-t border-primary"></div>
          </div>
        ...
        <div className="relative z-10 group">
          <Link 
            ...
            className={`flex items-center justify-center w-12 h-12 ${activeCategory === 'diger' ? 'bg-primary text-white' : 'bg-white'} rounded-full shadow-md border border-light-gray p-2.5 transition-all duration-300 hover:scale-110`}
          ...
          <div className="absolute right-14 top-1/2 -translate-y-1/2 bg-white backdrop-blur-sm px-3 py-2 rounded-lg shadow-lg text-sm whitespace-nowrap border border-primary opacity-0 group-hover:opacity-100 transition-all duration-300 pointer-events-none flex items-center gap-2 z-[100]">
            <span className="text-[#E31E24] font-medium">Diğer Hayvan Öyküleri</span>
            <div className="absolute top-1/2 -translate-y-1/2 right-[-6px] w-3 h-3 bg-white backdrop-blur-sm rotate-45 border-r border-t border-primary"></div>
          </div>
